<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtlDebitVoucher.ascx.cs" Inherits="Accounting.Web.UserControls.CtlDebitVoucher" %>
                    ...
                    <div class="panel-heading form-horizontal">
                        <div class="control-group">
                            <div class="controls form-inline">
                                <label>
                                    <asp:Literal ID="Literal2" runat="server" Text="Debit Voucher" />
                                </label>
                            </div>
                    ...
                    <div class="panel-body">
                        <table class="datatable">
                            ...
                            <tr class="row" runat="server" id="trLedgerNo">
                                <td class="InputLabel">
                                    <asp:Literal ID="Literal6" Text="Paid with" runat="server"></asp:Literal>
                                </td>
                                <td class="InputField">
                            ...
                            <tr class="row">
                                <td class="InputLabel">
                                    <asp:Literal ID="Literal8" Text="Paid To" runat="server"></asp:Literal></td>
                            ...
                            <tr class="row">
                                <td class="InputLabel">
                                    <asp:Literal ID="Literal9" Text="Paid From A/C" runat="server"></asp:Literal></td>
                                <td class="InputField" colspan="3">
                                    <cc1:CustomAccountDropDownListChosen ID="ddlPaidFromAC" runat="server"
                                                ...
                                                <div class="control-group">
                                                    <div class="controls form-inline" style="text-align: right;">
                                                        <label style="float: left;">
                                                         ...
                                                         <cc1:AccountDropDownListChosen ID="ddlPaidForAC" runat="server" Width="420px">
