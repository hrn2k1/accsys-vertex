<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtlJournalVoucher.ascx.cs" Inherits="Accounting.Web.UserControls.CtlJournalVoucher" %>
                    ...
                    <div class="panel-heading form-horizontal">
                        <div class="control-group">
                            <div class="controls form-inline">
                                <label>
                                    <asp:Literal ID="Literal2" runat="server" Text="Journal Voucher" />
                                </label>
                            </div>
