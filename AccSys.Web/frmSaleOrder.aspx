<%@ Page Title="" Language="C#" MasterPageFile="~/SiteEmpty.Master" AutoEventWireup="true" CodeBehind="frmSaleOrder.aspx.cs" Inherits="AccSys.Web.frmSaleOrder" %>
                            ...
                            <table class="datatable">
                                ...
                                <tr class="row">
                                    ...
                                    <td class="InputField">
                                        ...
                                        <ajax:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txtDeliveryDate" Format="dd/MM/yyyy"></ajax:CalendarExtender>
                                    </td>
                                    <td></td>
                                </tr>
                                <tr class="row">
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtRate" runat="server" Text="1" Visible="false" ValidationGroup="post"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr class="row">
                                                ...
                                                <div class="panel-heading form-horizontal">
                                                    <div class="control-group">
                                                        <div class="controls form-inline" style="text-align: right">
                                                            ...
                                                            <asp:LinkButton SecurityCommandName="Add" ID="btnAdd" runat="server" OnClick="btnAdd_Click" Text="Add" CssClass="btn btn-default btn-sm glyphicon glyphicon-plus-sign"
                                                                ValidationGroup="add" />
                                                        </div>
                                                    </div>
                                                </div>
