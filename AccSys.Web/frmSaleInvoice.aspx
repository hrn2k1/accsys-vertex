            ...
            <div class="panel-heading form-horizontal" style="text-align: right;">
                <div class="control-group">
                    <div class="controls form-inline">
                        ...
                        <cc1:AccountDropDownListChosen ID="ddlSrcAccount" runat="server" Width="250px" NullItemText="Select an account" NullItemValue="0">
                        </cc1:AccountDropDownListChosen>
                        <label>
            ...
            <div class="panel-body" style="min-height: 300px">
                <asp:GridView ID="gvData" runat="server" AllowPaging="True" CssClass="datatable"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Customer Account" SortExpression="CustomerAccountName">
                            <ItemTemplate>
                                <asp:Label ID="lblCustomerAccountName" runat="server" Text='<%# Bind("CustomerAccountName") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
