<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CtlVoucherRegister.ascx.cs" Inherits="AccSys.Web.UserControls.CtlVoucherRegister" %>
...
<asp:UpdatePanel ID="UpdatePanel2" runat="server">
    <ContentTemplate>
        ...
        <div class="grid" style="width: auto;">
            <div class="panel panel-success" style="min-height:400px;font-size:x-small;font-weight:normal;">
