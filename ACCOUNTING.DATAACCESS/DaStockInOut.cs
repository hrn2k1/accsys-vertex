    ...
    public class DaStockInOut
    {
        ...
        public void SaveUpdateStockInOutDetail(Stock_InOut_Detail obInOutDetail, SqlConnection con, SqlTransaction trans)
        {
            ...
            try
            {
                ...
                com.Parameters.Add("@Budle_Pack_Qty", SqlDbType.VarChar, 500).Value = obInOutDetail.Budle_Pack_Qty;
                com.Parameters.Add("@ShortQty", SqlDbType.Int).Value = obInOutDetail.ShortQty;
                com.Parameters.Add("@Specifications", SqlDbType.VarChar, 500).Value = obInOutDetail.Specifications;
                com.Parameters.Add("@Budle_Pack_Size", SqlDbType.VarChar, 500).Value = obInOutDetail.Budle_Pack_Size;
