   ...
   public class DaOpeningStock
    {
       ...
       public int SaveUpdateOpenningStock(OpeningStock obOpStk, SqlConnection con, SqlTransaction trans)
       {
           ...
           try
           {
               ...
               com.Parameters.Add("@ColorCode", SqlDbType.VarChar, 100).Value = obOpStk.Specifications;
               com.Parameters.Add("@Labdip", SqlDbType.VarChar, 100).Value = obOpStk.Budle_Pack_Size;
               com.Parameters.Add("@Remarks", SqlDbType.VarChar, 500).Value = obOpStk.Budle_Pack_Qty;
